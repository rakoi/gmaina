...
<body>
                    ...
                    <div class="col-md-8">
                        <div class="topbar-info d-flex flex-wrap">
                            <a href="#" class="text-light me-4"><i
                                    class="fas fa-envelope text-white me-2"></i>{{$siteSettings->email}}</a>
                            <a href="#" class="text-light"><i
                                    class="fas fa-phone-alt text-white me-2"></i>{{$siteSettings->telephone}}</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="topbar-icon d-flex align-items-center justify-content-end">
                            ...
                            <a href="{{$link->link}}" target="_blank" rel="noopener noreferrer"
                                class="btn-square text-white me-2">
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h3 class="text-white display-3 mb-4">All Reports</h1>
        </div>
    </div>
    <!-- Header End -->
    <!-- Blog Start -->
            ...
            <div class="row g-4 align-items-center">
                <div class="col-md-4 text-center text-md-start mb-md-0">
                    <span class="text-body"><a href="#"><i
                                class="fas fa-copyright text-light me-2"></i>{{$siteSettings->sitename}}</a> All right
                        reserved.</span>
                </div>
